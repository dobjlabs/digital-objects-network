...
| `joint-tx`                       | Assembling one transaction across parties. Contributions a holder proves for someone else's assembly, the shared `TxPlan`, and the proving schedule. Depends on `txlib`; nothing depends on it yet.  |
