...
// === Event subscriptions ====================================================
//
// Driver events (`objects-changed`, `run-action-progress`, `mcp-action-started`)
// always come from dobjd over a single SSE connection. The `open-settings`
// event comes from the Tauri native menu and is desktop-only.
