---
name: bitcraft-game-rules
description: Game rules — show bitcraft's tech tree, action mechanics, and how to play.
---
...
1. Call the MCP tool `ReadMcpResourceTool` with `server: "bitcraft"` and `uri: "bitcraft://docs/game-rules"`.
