...
What is DON: [Digital Objects Network](/network) (original write-up on
[HackMD](https://hackmd.io/@gubsheep/rJKUDi-2bl))
...
```
Digital Object files ◄────► Driver ◄──────────────────────────────┐
                              │                                   │
                              │ submit update                     │ canonical state
                              ▼                                   │
                           Relayer                                │
                              │ publish blob                      │
                              ▼                                   │
                       Ethereum blobs ───────────────────► Synchronizer
                              │         read recent blobs         ▲
                              │ persist blobs                     │ serve historical blobs
                              ▼                                   │
                           Archiver ──────────────────────────────┘
```
