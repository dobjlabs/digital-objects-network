...
[craft-basics](/applications/craft-basics) or
[craft-rocket](/applications/craft-rocket).
...
The guide walks the agent through every step below and includes instructions
for plugin install and MCP connection. Setup takes a couple of minutes.
...
- [craft-basics](/applications/craft-basics) — a small crafting demo.
- [craft-rocket](/applications/craft-rocket) — a larger factory tech tree.
