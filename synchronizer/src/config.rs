...
const DEFAULT_APP_STATE_DB: &str = "data/synchronizer-db";
const DEFAULT_SYNC_METADATA_DB: &str = "postgres://postgres@localhost:5432/synchronizer";
...
pub fn load_config() -> Result<AppConfig> {
    ...
    let app_state_db =
        dotenvy::var("APP_STATE_DB").unwrap_or_else(|_| DEFAULT_APP_STATE_DB.to_string());
    let sync_metadata_db =
        dotenvy::var("SYNC_METADATA_DB").unwrap_or_else(|_| DEFAULT_SYNC_METADATA_DB.to_string());
